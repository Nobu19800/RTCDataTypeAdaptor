...
python RTCDataTypeAdaptor/bin/generate_adaptor.py test/InterfaceDataTypes.idl -Itest -bc -v -o test_out_c
# python RTCDataTypeAdaptor/bin/generate_adaptor.py test/ExtendedDataTypes.idl -Itest -bc -v -o test_out_c
